...
public class StockAnalytics {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        DataAnalysis analyser = new DataAnalyzerRFC("localhost", 1333);
...
//        sample = analyser.simpleMovingAverage(10, sample);
...
//        }
        ...
        // closes connection to database, socket, etc. depending on what kind of analyser you are using
        analyser.terminate();
